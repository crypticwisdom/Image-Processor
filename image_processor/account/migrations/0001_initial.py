# Generated by Django 4.1.3 on 2022-12-12 23:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_threshold_size', models.DecimalField(decimal_places=2, default=0, help_text='Any file size above this threshold will be rejected.', max_digits=10)),
                ('image_dimension_threshold', models.PositiveSmallIntegerField(default=0, help_text='image dimension will be used to validate both width and height.')),
                ...
                ('content_type', models.ManyToManyField(help_text="What ever type of content type that has been selected by the client will be allowed for his Image Processing. E.g {'jpeg': 'image/jpeg'}, it means images with content type of jpeg will be acceptable.", to='management.applicationcontenttype')),
            ],
        ),
    ]
